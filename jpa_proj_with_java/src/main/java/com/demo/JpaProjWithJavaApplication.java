...
import com.demo.service.JpaService;
import com.demo.service.jpaServiceImpl;

@SpringBootApplication
public class JpaProjWithJavaApplication {

	public static void main(String[] args) {
		//SpringApplication.run(JpaProjWithJavaApplication.class, args);
		//get IOC container
				ApplicationContext ctx=SpringApplication.run(JpaProjWithJavaApplication.class, args);
				//  get Service class obj ref
				JpaService service=ctx.getBean("jpaServiceImpl",jpaServiceImpl.class);
				/*//invoke the method
				try {
